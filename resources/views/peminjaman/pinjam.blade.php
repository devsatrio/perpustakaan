            ...
            <div class="block">
                ...
                <form class="row form-bordered">
                    <div class="form-group col-md-6">
                        ...
                        <select id="cari_anggota" name="example-select2" class="select-select2" style="width: 100%;"
                            data-placeholder="Cari Nama Anggota..">
                        </select>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select id="buku" name="example-select2" class="select-select2" style="width: 100%;"
                            data-placeholder="Cari Judul Buku..">
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="example-nf-email">ISBN</label>
                        <input type="text" id="isbn_buku" class="form-control" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="example-nf-email">Penerbit</label>
                        <input type="text" id="penerbit_buku" class="form-control" readonly>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="tanggal_kembali" name="example-datepicker3"

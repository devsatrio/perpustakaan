    ...
    <div class="container text-center">
        ...
        <div class="row row-items">
            ...
            <div class="col-sm-4">
                ...
                <br>
                <br>
                <div class="visibility-none" data-toggle="animation-appear"
                    data-animation-class="animation-fadeInQuick2Inv" data-element-offset="-100">
                    <h4 class="site-heading feature-heading"><strong>Bootstrap Powered</strong></h4>
                    <p class="feature-text text-muted">Bootstrap is a sleek, intuitive, and powerful mobile first
                        front-end framework for faster and easier web development. <strong>AppUI</strong> was built on
                        top, extending it to a large degree.</p>
                </div>
            </div>
            @endforeach
        </div>
        ...
        <div class="site-block text-center">
            <form action="features.html" method="post" class="form-inline" onsubmit="return false;">
                <div class="form-group">
                    ...
                    <input type="text" id="register-username" name="register-username" class="form-control input-lg"

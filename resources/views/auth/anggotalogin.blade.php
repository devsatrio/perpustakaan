...
<body>
    ...
    <img src="{{asset('assets/img/placeholders/layout/login2_full_bg.jpg')}}" alt="Full Background"
    ...
    <div id="login-container">
        ...
        <div class="block animation-fadeInQuick">
            ...
            <form method="POST" id="form-login" class="form-horizontal" action="{{ route('login-anggota') }}">
                ...
                <div class="alert alert-danger alert-dismissible alert-mg-b-0" role="alert">
                    ...
                    atau password salah, check kembali akun anda.
                </div>
                @endif
                    ...
                    <div class="col-xs-8">
                        <label class="csscheckbox csscheckbox-primary">
                            <input class="form-check-input" type="checkbox" name="remember" id="remember"
                                {{ old('remember') ? 'checked' : '' }}><span></span> Ingat Saya?
                        </label>
                    </div>
        ...
        <footer class="text-muted text-center animation-pullUp">
            <small><span>12-2018</span> &copy; <a href="http://goo.gl/RcsdAh" target="_blank">Perpustakaan
                    1.0</a></small>
        </footer>
        <!-- END Footer -->
    </div>

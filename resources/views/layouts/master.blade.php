                ...
                <div id="sidebar">
                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                <li>
                                    <a href="{{url('/home')}}"><i class="gi gi-compass sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Dashboard</span></a>
                                </li>
                                ...
                                <li>
                                    <a href="{{url('/user')}}"><i class="gi gi-user sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">User</span></a>
                                </li>
                                <li>
                                    <a href="page_app_email.html"><i class="gi gi-group sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Anggota</span></a>
                                </li>
                                <li>
                                    <a href="{{url('/buku')}}"><i class="gi gi-book sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Buku</span></a>
                                </li>
                               <li>
                                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-tasks sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Peminjaman Buku</span></a>
                                    <ul>
                                        <li>
                                 ...
                                 <li>
                                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-line-chart sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Statistik</span></a>
                                    <ul>
                                        <li>
                                 ...
                                 <li>
                                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-bomb sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Daftar Denda</span></a>
                                    <ul>
                                        <li>
                    ...
                    <div id="sidebar-extra-info" class="sidebar-content sidebar-nav-mini-hide">
                        ...
                        <div class="text-center">
                            <small>Dibuat Oleh <i class="fa fa-heart text-danger"></i><a href="http://goo.gl/vNS3I" target="_blank"> Kelompok 9</a></small><br>
